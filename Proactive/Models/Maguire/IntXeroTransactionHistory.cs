...
{
    public partial class IntXeroTransactionHistory
    {
        public IntXeroTransactionHistory()
        {
            IntXeroTransactionHistoryLineObjs = new HashSet<IntXeroTransactionHistoryLine>();
            IntXeroTransactionHistoryLineXeroThs = new HashSet<IntXeroTransactionHistoryLine>();
        }
        ...
        public virtual ICollection<IntXeroTransactionHistoryLine> IntXeroTransactionHistoryLineObjs { get; set; }
        public virtual ICollection<IntXeroTransactionHistoryLine> IntXeroTransactionHistoryLineXeroThs { get; set; }
    }
}
