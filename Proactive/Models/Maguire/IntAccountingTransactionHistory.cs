...
{
    public partial class IntAccountingTransactionHistory
    {
        public IntAccountingTransactionHistory()
        {
            IntAccountingTransactionHistoryLines = new HashSet<IntAccountingTransactionHistoryLine>();
        }
        ...
        public virtual ICollection<IntAccountingTransactionHistoryLine> IntAccountingTransactionHistoryLines { get; set; }
    }
}
