...
{
    public partial class VTouchPoint
    {
        ...
        public string SocAccount { get; set; }
        public string SocProfileUrl { get; set; }
        ...
        public string TpCategoryHlight { get; set; }
        public string TpType { get; set; }
        public string TpTypeHlight { get; set; }
