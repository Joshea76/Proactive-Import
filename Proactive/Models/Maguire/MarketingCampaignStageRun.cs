...
{
    public partial class MarketingCampaignStageRun
    {
        public MarketingCampaignStageRun()
        {
            MarketingCampaignStageMessages = new HashSet<MarketingCampaignStageMessage>();
            MarketingCampaignStageRunClicks = new HashSet<MarketingCampaignStageRunClick>();
        ...
        public virtual ICollection<MarketingCampaignStageRunClick> MarketingCampaignStageRunClicks { get; set; }
